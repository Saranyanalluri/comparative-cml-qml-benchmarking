...
print("=" * 75)
print("BARS AND STRIPES - 8 MODEL CML vs QML BENCHMARK")
print("=" * 75)


# ============================================================
# 1. GENERATE BARS AND STRIPES DATASET
# ============================================================
...
def generate_bars_and_stripes(
    ...
    for i in range(n_samples):
        ...
        if label == 0:
            ...
            col_pattern = rng.integers(
                0,
                2,
                size=n_features_sqrt
            )

            # Avoid completely empty image
            if np.sum(col_pattern) == 0:

                col_pattern[
                    rng.integers(n_features_sqrt)
                ] = 1
...
X, y = generate_bars_and_stripes(
    n_samples=n_samples,
    n_features_sqrt=n_features_sqrt,
    random_state=42
)
...
print(
    f"Image size    : "
    f"{n_features_sqrt} x {n_features_sqrt}"
)
...
results_file = (
    "bars_stripes_8model_benchmark_results.csv"
)
...
print("\n" + "=" * 75)
print("FINAL BARS AND STRIPES 8-MODEL BENCHMARK SUMMARY")
print("=" * 75)
...
summary_file = (
    "bars_stripes_8model_benchmark_summary.csv"
)
...
print(
    "\nBars and Stripes 8-model benchmark "
